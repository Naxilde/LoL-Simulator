...
<body>
  <div id="main">
    <div id="header">
      <div id="logo">
	<h1><span class="alternate_colour">{{name1}} vs {{name2}}</span></h1>
      </div>
      <div id="menubar">
        <ul id="menu">
    ...
    <div id="site_content">
      <div id="panel1"><img src="/static/images/{{champ1}}.jpg" alt=champ1 /><img src="/static/images/{{champ2}}.jpg" alt=champ2 /></div>
      <div class="sidebar">
